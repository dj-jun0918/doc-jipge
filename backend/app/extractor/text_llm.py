...
출력: {
  "fields": [
    {"field_name": "업력", "condition": "창업 7년 이하", "operator": "이하", "value": 7, "evidence": "| 업력 | 창업 7년 이하 |"},
    {"field_name": "매출", "condition": "연 50억원 이하", "operator": "이하", "value": 5000000000, "evidence": "| 매출 | 연 50억원 이하 |"},
    {"field_name": "지역", "condition": "경기도 소재", "operator": "소재", "value": "경기", "evidence": "| 지역 | 경기도 소재 |"},
    {"field_name": "인증", "condition": "벤처기업 보유", "operator": "보유", "value": "venture_company", "evidence": "| 인증 | 벤처기업 보유 |"}
  ],
